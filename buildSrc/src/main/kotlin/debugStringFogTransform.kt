...
abstract class debugStringFogTransform : AsmClassVisitorFactory<InstrumentationParameters.None> {
    ...
    companion object {
        ...
        fun setParameters(extension: StringFogExtension, printFile: File, className: String) {
            debugStringFogTransform.extension = extension
            debugStringFogTransform.className = className
